...
# if the git repo "country_analysis" is located in the same directory as "RegioCLim" the following commands import country_analysis
sys.path.append(basepath+'country_analysis')
# if the git repo "wlcalculator" is located in the same directory as "RegioCLim" the path is correct.
