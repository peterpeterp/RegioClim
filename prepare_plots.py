...
indicator_dict={
  '10day_below_1std_pr':{'long_name':'10 day precipitation below 1 standard deviation of reference','unit':'mm'}
}
...
COU={}
COU['SEN']=country_analysis('SEN','/Users/peterpfleiderer/Documents/Projects/country_analysis/SEN/',seasons={'year':range(1,13),'Jun-Sep':[6,7,8,9],})
COU['BEN']=country_analysis('BEN','/Users/peterpfleiderer/Documents/Projects/country_analysis/BEN/',seasons={'year':range(1,13),'Apr-Jul':[4,5,6,7]})

for country in COU.keys():
  COU[country].load_data()
  COU[country].data_summary()
  COU[country].unit_conversions()
  COU[country].period_statistics(periods={'ref':[1986,2006]},selection=COU[country].selection(['EWEMBI']))
...
#       if cordex.time_format=='monthly':   seasons=COU[country]._seasons.keys()
#       if cordex.time_format=='10day':   seasons=COU[country]._seasons.keys()
#       if cordex.time_format=='yearly':    seasons=['year']
      
#       for season in seasons:
#         print season,indicator,country
#         # ewembi map
